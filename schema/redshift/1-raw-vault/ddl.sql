CREATE SCHEMA TPCHRV;
SET SEARCH_PATH TO TPCHRV;
...
(
    ...
    DISTKEY (DVS_HUB_ORDER)
    SORTKEY (DVS_HUB_ORDER);
...
(
    ...
    DISTKEY (DVS_HUB_PART)
    SORTKEY (DVS_HUB_PART);
...
(
    ...
    DISTKEY (DVS_HUB_SUPPLIER)
    SORTKEY (DVS_HUB_SUPPLIER);
...
(
    ...
    DISTKEY (DVS_HUB_ORDER)
    SORTKEY (DVS_HUB_ORDER, DVS_HUB_CUSTOMER);
...
(
    ...
    DISTKEY (DVS_HUB_PART)
    SORTKEY (DVS_HUB_PART, DVS_HUB_SUPPLIER);
...
(
    ...
    DISTKEY (DVS_HUB_ORDER)
    SORTKEY (DVS_HUB_ORDER,DVS_HUB_SUPPLIER, DVS_HUB_PART);
...
(
    ...
    DISTKEY (DVS_HUB_ORDER)
    SORTKEY (O_ORDERDATE, O_ORDERSTATUS );
